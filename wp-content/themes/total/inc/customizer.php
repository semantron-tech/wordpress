...
function total_customize_register($wp_customize) {
	...
	<li>' . esc_html__("One click demo import", "total") . '</li>
        <li>' . esc_html__("5+ Demos built in both Customizer and Elementor", "total") . '</li>
        <li>' . esc_html__("Website that can be built with Customizer or Elementor", "total") . '</li>
        <li>' . esc_html__("18 Front page sections with lots of variations", "total") . '</li>
	<li>' . esc_html__("21+ Elementor Elements", "total") . '</li>
    ...
    $wp_customize->add_section(new Total_Customize_Upgrade_Section($wp_customize, 'total-upgrade-section', array(
        ...
        'priority' => 1000,
        'options' => array(
            esc_html__('- All Sections Buildable by Elementor', 'total'),
